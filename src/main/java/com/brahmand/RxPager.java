...
/**
 * Created by adarshpandey on 11/23/15.
 */
public class RxPager<I, O> {
    ...
    public static <T> RxPager<T, T> create(PagingFunction<T> pagingFunction) {
        return new RxPager<>(pagingFunction, UtilityFunctions.<T>identity());
    }

    public static <I, O> RxPager<I, O> create(PagingFunction<I> pagingFunction, Func1<I, O> pageTransformer) {
        return new RxPager<>(pagingFunction, pageTransformer);
    }

    RxPager(PagingFunction<I> pagingFunction, Func1<I, O> pageTransformer) {
